...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-04-2016 a las 18:09:15
...
(8, '2015-08-11', ' compra de vidrio', 0, 11000),
...
(5, 'Tablet', 'Nokia', 'lumia 400', ' teclado no sirve', 'protector rayado', 30000, 40000, '2016-04-05', 4, '01', 25000);
...
--
ALTER TABLE `tbcompra`
  MODIFY `numero_compra` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `tbmovimiento`
  MODIFY `idmovimiento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=76;
--
