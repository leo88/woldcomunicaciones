...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2016 a las 17:58:48
...
CREATE TABLE `tbcompraxproducto` (
  `numero_compra` int(11) NOT NULL,
...
CREATE TABLE `tbdevolucionirregular` (
...
ALTER TABLE `tbcompraxproducto`
  ADD PRIMARY KEY (`numero_compra`,`movimiento`),
...
ALTER TABLE `tbdevolucionirregular`
  ...
  ADD KEY `movimiento` (`movimiento`,`numero_compra`);
...
ALTER TABLE `tbventaxproducto`
  ADD PRIMARY KEY (`numero_venta`,`movimiento`),
  ADD KEY `movimiento` (`movimiento`);
...
--
ALTER TABLE `tbcompra`
  MODIFY `numero_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `tbmovimiento`
  MODIFY `idmovimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
--
